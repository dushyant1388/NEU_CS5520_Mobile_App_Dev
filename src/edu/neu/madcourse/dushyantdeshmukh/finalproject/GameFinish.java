...
public class GameFinish extends Activity implements OnClickListener {
	...
	private void showFinalResultToPlayer() {
		String playerTime = projPreferences.getString(
				ProjectConstants.PLAYER_TIME, null);
		String oppTime = projPreferences.getString(
				ProjectConstants.OPPONENT_TIME, null);
		String playerImageCount = projPreferences.getString(
				ProjectConstants.PLAYER_IMAGE_COUNT, null);
		String oppImageCount = projPreferences.getString(
				ProjectConstants.PLAYER_IMAGE_COUNT, null);
		if (playerTime != null || oppTime != null || playerImageCount != null
				|| oppImageCount != null) {
			if (Integer.parseInt(playerTime) > Integer.parseInt(oppTime)) {
				finalScoreText.setText("You lost!!! \n You captured "
						+ playerImageCount + " out of "
						+ ProjectConstants.TOTAL_NO_OF_IMAGES + " images in "
						+ Util.getTimeStr(Integer.parseInt(playerTime)) + " mins \n"
						+ "Your opponent captured " + oppImageCount
						+ " out of " + ProjectConstants.TOTAL_NO_OF_IMAGES
						+ " images in "
						+ Util.getTimeStr(Integer.parseInt(oppTime))+ " mins") ;
				...
				if (Integer.parseInt(playerImageCount) > Integer
						.parseInt(oppImageCount)) {
					finalScoreText.setText("You lost!!! \n You captured "
							+ playerImageCount + " out of "
							+ ProjectConstants.TOTAL_NO_OF_IMAGES
							+ " images in "
							+ Util.getTimeStr(Integer.parseInt(playerTime))
							+ " mins \n" + "Your opponent captured " + oppImageCount
							+ " out of " + ProjectConstants.TOTAL_NO_OF_IMAGES
							+ " images in "
							+ Util.getTimeStr(Integer.parseInt(oppTime))+ " mins");
				} else if (Integer.parseInt(playerImageCount) < Integer
						.parseInt(oppImageCount)) {
					finalScoreText.setText("You won!!! \n You captured "
							+ playerImageCount + " out of "
							+ ProjectConstants.TOTAL_NO_OF_IMAGES
					...
					finalScoreText.setText("Scores Tied!!! You captured "
							+ playerImageCount + " out of "
							+ ProjectConstants.TOTAL_NO_OF_IMAGES
							+ " images in "
							+ Util.getTimeStr(Integer.parseInt(playerTime))
